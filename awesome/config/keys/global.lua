...
local globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey }, "=", function () awful.util.spawn("/home/theodugautier/.i3/i3lock-fancy-multimonitor/lock --blur=0x4") end),
    ...
    awful.key({ modkey }, "a", function () awful.spawn(apps.default.editor) end,
    ...
    --]]
    -- Prompt
    awful.key({ modkey }, "d", function () awful.util.spawn("rofi -no-lazy-grab -show drun -theme config.rasi") end,
